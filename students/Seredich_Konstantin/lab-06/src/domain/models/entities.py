...
class Deck:
    ...
    def add_card(self, card_id: str, term: str, definition: str):
        ...
        self._events.append(CardAddedToDeckEvent(datetime.now(), self.id, card_id, term))
    ...
    def review_card(self, card_id: str, grade_score: int):
        ...
        self._events.append(CardReviewedEvent(datetime.now(), card_id, grade_score, new_interval))
